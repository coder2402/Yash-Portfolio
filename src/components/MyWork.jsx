                    ...
                    work.map(({id, src, title, codeLink, demoLink}) => (
                        <div key={id} className='shadow-md shadow-gray-600 rounded-lg bg-gradient-to-r from-gray-800 via-gray-400 to-gray-800'>
                            ...
                            <div className='flex items-center justify-center bg-gradient-to-r from-gray-800 via-gray-400 to-gray-800'>
                                {demoLink && (
                                <a href={demoLink} target='_blank' rel="noreferrer" className='w-1/2 px-6 py-2 m-4 duration-200 hover:scale-105 bg-gradient-to-r from-gray-800 to-gray-400 text-center block rounded-md'>Demo</a>
                                    
                                )}
                                <a href={codeLink} target='_blank' rel="noreferrer" className='w-1/2 px-6 py-2 m-4 duration-200 hover:scale-105 bg-gradient-to-r from-gray-400 to-gray-800 text-center block rounded-md'>Code</a>
                            </div>
                        </div>
