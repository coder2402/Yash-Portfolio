            ...
            <div className='w-full grid grid-cols-1 sm:grid-cols-2 gap-8 text-center py-8 px-12 sm:px-0'>
                ...
                <div className='flex justify-center items-center'>
                    ...
                    method='post' className='flex flex-col w-full md:w-1/2'>
                        <input type="text" name='name' placeholder='Enter your name' aria-label="Enter your name" required className='p-2 bg-transparent border-2 rounded-md text-white focus:outline-none focus:border-cyan-500 duration-300'/>

                        <input type="email" name='email' placeholder='Enter your email' aria-label="Enter your email" required className='p-2 my-4 bg-transparent border-2 rounded-md text-white focus:outline-none focus:border-cyan-500 duration-300'/>

                        <textarea name="message" rows="10" placeholder='Enter your message' aria-label="Enter your message" required className='p-2 bg-transparent border-2 rounded-md text-white focus:outline-none focus:border-cyan-500 duration-300'></textarea>
